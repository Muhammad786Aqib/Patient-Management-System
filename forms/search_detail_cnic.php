...
<?php 
$pcnic=$_REQUEST['pcnic'];
$onlyAdmitted = $_REQUEST['onlyAdmitted1'];
if($onlyAdmitted == "yes")
	$result3 = mysql_query("SELECT * FROM app,room_allotment where cnic='$pcnic'  AND room_allotment.p_id=app.p_id ");
else
	$result3 = mysql_query("SELECT * FROM app where cnic='$pcnic' ");
